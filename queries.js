...
const createUserInfo = (request, response) => {
    ...
    let query2 = format('INSERT INTO results_user_form (user_id, sex, age, profession, years_education, level_education, version_task, prolific_pid, study_id, session_id, numer_osoby) VALUES %L Returning *;', form);
...
const createUserAttributes = (request, response) => {
    ...
    const query = format('INSERT INTO results_user_attribute (user_id, screen_name, questionID, questionNumber, selectedAnswer, isCorrectAnswer, support_type, button_clicked, reaction_time) VALUES %L Returning *', data)
